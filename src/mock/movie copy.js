...
const testComments = generateComments(125);
...
const test = generateMovie(arrayOfCommentsIds);
console.log(test);

// const generateMovies = (number, array) => {
  // return generateArray(number, generateMovie(array));
// };

// const result = generateMovies(5, arrayOfCommentsIds);
// console.log(result);
